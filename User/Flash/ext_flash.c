...
#define GD25Q128E_SIZE_BYTES EXT_FLASH_SIZE_BYTES
#define GD25Q128E_PAGE_SIZE EXT_FLASH_PAGE_SIZE_BYTES
#define GD25Q128E_SECTOR_SIZE EXT_FLASH_SECTOR_SIZE_BYTES
